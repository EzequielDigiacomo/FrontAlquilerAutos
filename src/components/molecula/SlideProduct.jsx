    ...
    return (
        <section className='grid md:grid-cols-4 md:gap-4'>
           <div className='col-span-4 relative '>
            ...
            <img src={AudiA4} alt="" className='hidden md:block' />
            <img src={AudiA5} alt="" className='hidden md:block'/>
            <img src={Peugeot408} alt="" className='hidden md:block'/>
            <img src={FordEscort} alt="" className='hidden md:block'/>
        </section>
    )
}
